...
async def start(message: types.Message, state: FSMContext):
    if STUB_MODE:
        ...
        await message.answer(
            "🔧 Мастера по дверям и кухням\n"
            "📍 Москва\n"
            "👤 Мужчины 18+, опыт от 1 года, свои инструменты\n"
            "👥 Руки — сервис заказов для мастеров с 2017 года.\n"
            "Работа с крупными партнёрами: Леруа Мерлен, ПИК, М.Видео.\n\n"
            "• Стабильные заказы круглый год\n"
            "• Выплаты ежедневно на карту\n"
            "• Вы сами выбираете заказы в приложении\n"
            "• Без депозитов и предоплат\n"
            "• Гарантированный доход до 200 000 ₽ (при полной загрузке)\n\n"
            "📄 Заполнить анкету: https://advgo.ru/Rfh51C"
        )

        await message.answer(
            "🚶Курьер\n"
            "📍Санкт-Петербург\n"
            "👤 18+, права (B / M / A / A1), русский язык, можно без опыта.\n"
            "👥 Burger King — крупный работодатель с постоянным набором персонала.\n\n"
            "• Еженедельные выплаты, чаевые\n"
            "• Самозанятость «под ключ» (налоги платит компания)\n"
            "• Бесплатное питание\n"
            "• Без штрафов\n"
            "• Компенсация транспорта (авто/вело/мото), гибкий график.\n\n"
            "📄 Заполнить анкету: https://advgo.ru/yQ7m5z"
        )

        await message.answer(
            "🧑‍🍳 Повар-кассир\n"
            "📍 Вся Россия\n"
            "👤 18+, русский язык, без опыта.\n"
            "👥 Burger King — крупный работодатель с постоянным набором персонала.\n\n"
            "• Официальное оформление, зарплата на карту,\n"
            "• Бонусы,\n"
            "• Гибкий график,\n"
